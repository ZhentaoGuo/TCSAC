...
from dataset import WorkpieceLoader
...
def eval_3DMatch(config, use_icp):
    ...
    for scene_ind, scene in enumerate(scene_list):
        loader = WorkpieceLoader(root=config.data_path,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_path', default='config_json/config_workpiece.json', type=str, help='snapshot dir')
    ...
    if not os.path.exists("./logs"):
        os.makedirs("./logs")
    log_filename = f'logs/TCSAC_workpiece-{config.descriptor}.log'
